...
import 'package:food_delivery_22091a/models/user.dart'; // Assuming this file exists
import 'package:food_delivery_22091a/loading.dart';
import 'package:food_delivery_22091a/authenticate/register.dart'; // Assuming this file exists
  ...
  Widget build(BuildContext context) {
    ...
    if (user != null) {
      return FutureBuilder<DocumentSnapshot>(
        future: FirebaseFirestore.instance.collection('user_accounts').doc(user.uid).get(),
