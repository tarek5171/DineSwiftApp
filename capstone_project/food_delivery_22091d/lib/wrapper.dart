...
import 'package:food_delivery_22091d/authenticate/authenticate.dart';
import 'home/home_page.dart';
import 'package:food_delivery_22091d/models/user.dart';
        ...
        return FutureBuilder<DocumentSnapshot?>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError || snapshot.data == null) {
              ...
              return _StatusPage(
                message: 'An error occurred. your account may have been disabled. please try again later or contact adminstrator.',
                onComplete: () {
